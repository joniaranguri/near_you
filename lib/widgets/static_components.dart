...
final  List<String> daysList = ["Lun", "Mar", "Mier", "Jue", "Vier", "Sáb", "Dom"];
final  List<String> weeksList = ["1ra Sem", "2da Sem", "3ra Sem", "4ta Sem"];
final  List<String> monthsList = ["Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Set", "Oct", "Nov", "Dic"];
